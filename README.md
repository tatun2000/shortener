...
# Возможности сервиса
## Добавление ссылки в хранилище по url: http://localhost:8080/a/?url=длинная_ссылка
...
## Переход по сокращенной ссылки по url: http://localhost:8080/s/короткая_ссылка
